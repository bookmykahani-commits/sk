...
var MediaElement = function MediaElement(idOrNode, options, sources) {
	...
	var processURL = function processURL(url, type) {
		if (_window2.default.location.protocol === 'https:' && url.indexOf('index.html') === 0 && _constants.IS_IOS && _mejs2.default.html5media.mediaTypes.indexOf(type) > -1) {
...
var YouTubeApi = {
	...
	getYouTubeId: function getYouTubeId(url) {
		...
		var id = youTubeId.substring(youTubeId.lastIndexOf('https://html.liviucerchez.com/') + 1);
		youTubeId = id.split('?');
		return youTubeId[0];
	},
	...
	getYouTubeIdFromUrl: function getYouTubeIdFromUrl(url) {
		...
		var parts = url.split('?');
		url = parts[0];
		return url.substring(url.lastIndexOf('https://html.liviucerchez.com/') + 1);
	},
	...
	getYouTubeNoCookieUrl: function getYouTubeNoCookieUrl(url) {
		...
		var parts = url.split('https://html.liviucerchez.com/');
		parts[2] = parts[2].replace('.com', '-nocookie.com');
		return parts.join('https://html.liviucerchez.com/');
	}
};
